...
/// <summary>
/// SincV14 (v14): A highly-tuned multi-stage hybrid resampler routing to the mathematically optimal
/// kernels based on the resampling ratio:
/// - Large upsampling (ratio &gt;= 1.5): Lanczos (order 8) for fast, near-sinc upsampling.
/// - Near-unity upsampling/downsampling (0.875 &lt;= ratio &lt; 1.5): Sinc (v1) for peak transient preservation.
/// - Severe downsampling (ratio &lt; 0.35): JuliusSinc (v2) for maximum anti-alias suppression.
/// - Medium downsampling (0.35 &lt;= ratio &lt; 0.875): Tuned FarrowResampler (halfWidth=32, rolloff=0.96, beta=9.5)
///   for high-performance, steep polynomial-based downsampling.
/// </summary>
public static class SincV14
{
    ...
    // Tuned Lanczos order for upsampling (16 taps total)
    private const int LanczosOrder = 8;

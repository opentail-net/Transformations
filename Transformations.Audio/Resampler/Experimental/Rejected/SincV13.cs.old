...
/// <summary>
/// SincV13 (v13): A multi-stage hybrid resampler routing to the mathematically optimal
/// kernels based on the resampling ratio:
/// - Large upsampling (ratio &gt;= 1.5): Lanczos (order 6) for fast, high-fidelity upsampling.
...
/// - Medium downsampling (0.35 &lt;= ratio &lt; 0.875): FarrowResampler for fast, polynomial-based downsampling.
/// </summary>
public static class SincV13
{
    ...
    private const int LanczosOrder = 6;
        ...
        double nearUnityThreshold)
    {
        ...
        {
            return FarrowResampler.Resample(inputData, inRate, outRate, channels);
        }
    }
}
